...
class AppTheme {
  ...
  static const Color primaryBlue =
      Color(0xFF0B2A4E); // Deep Ocean Blue - trust, reliability
  static const Color secondaryTeal =
      Color(0xFF148A8A); // Professional Teal - innovation
  ...
  static const Color backgroundGrayF6 =
      Color(0xFFF6F6F6); // Light Gray - modern background
