...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _buildActionButton(Icons.logout_rounded, AppTheme.errorRed, () => _showLogoutDialog()),
                  ],
                ),
              ),
                ...
                child: myTemplates.isNotEmpty
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (index >= myTemplates.length) return const SizedBox.shrink();
                          ...
                          return AnimatedContainer(
                            ...
                            margin: EdgeInsets.only(
                              right: index == myTemplates.length - 1 ? 0 : AppSpacing.sm,
                            ),
                            child: _buildMyTemplateCard(template, index),
                          );
                        },
                      )
                    : Center(
                ...
                child: _getFilteredTemplates().isNotEmpty
                    ? GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (index >= filteredTemplates.length) return const SizedBox.shrink();
  ...
  Widget _buildMyTemplateCard(Map<String, String> template, int index) {
    ...
    return meaningfulLines.isNotEmpty 
        ...
        : lines.isNotEmpty ? lines.first : 'No content';
  }

  Widget _buildTemplateCard(String title, String body, int index, VoidCallback onTap) {
    return TweenAnimationBuilder(
